...
### <HopeIcon icon="user" /> YOU MING 柚明

---

::: tip 身份
- **工作室身份：** <Badge text="工作室室长" type="tip" vertical="middle" />
:::
...
- **哔哩哔哩：**[个人空间](https://space.bilibili.com/1337092956)

### <HopeIcon icon="user" /> 某团一笑

---

::: tip 身份
- **工作室身份：** <Badge text="工作室成员" type="info" vertical="middle" />
:::
...
- **哔哩哔哩：**[个人空间](https://space.bilibili.com/3493093632379150)

### <HopeIcon icon="user" /> Shadow
...
## <HopeIcon icon="font-awesome" /> 我们的所有旗下

::: tip YM 作品项目
- [MC 鼠标指针](/作品文档/MC%20鼠标指针.html)
:::
...
::: info YOU MING 审核
- 这是 YOU MING 工作室 的官方审核
- 用于回复`反馈`、审核`编辑和发布权` 和 处理`违规行为`
:::
