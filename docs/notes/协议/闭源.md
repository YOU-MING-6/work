...
<p>遵循 <a href="https://work.youming.v6.army/notes/协议/闭源.html">此协议</a>。</p>
```
...
本作品引用自 原作品名称（原作品链接）
原作者：原作者名称（原作者主页链接）
遵循协议：https://work.youming.v6.army/notes/协议/闭源.html
```

:::

- <strong>查看权限：</strong>  
允许使用者作品的内容（例如欣赏、观看等），但禁止用于直接或间接盈利目的；  
我们仅提供作品的预览，不提供下载。
