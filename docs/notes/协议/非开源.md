...
<p style="font-size: 18px; font-weight: 650">未授权：</p>

- 允许查看作品内容（但禁止进行逆向工程）
- 分享转载时注明来源信息
- 可以尝试 适当模仿 作品的内容
- 禁止用于任何用途（如修改、发布、商业、盈利等）
- 不可转让

<p style="font-size: 18px; font-weight: 650">已授权：</p>
...
## 3. 授权条款
### 3.1 未授权 权限范围:[mingcute:lock-line 22px/#fa5252]:

如已发送申请，请查看 [已授权 权限范围](#_4-已授权条款)
...
<p>原作者：<a href="原作者主页链接">原作者名称</a></p> <!--- 可选 --->
<p>遵循 <a href="https://work.youming.v6.army/notes/协议/申请.html">此协议</a>。</p>
```
...
本作品引用自 原作品名称（原作品链接）
原作者：原作者名称（原作者主页链接）
遵循协议：https://work.youming.v6.army/notes/协议/申请.html
```
...
- <strong>使用权限：</strong>  
禁止将作品用于任何用途；可以尝试 适当模仿 作品的内容，但禁止进行逆向工程、反编译、解密、反汇编或其他任何试图获取作品内部技术细节的行为。
...
- <strong>禁止商业盈利目的：</strong>  
禁止将本作品用于任何直接或间接商业、盈利目的。
...
如需获得作品的授权，请打开 [发送授权申请](/notes/反馈中心/发送授权申请.html) 按照步骤进行操作申请。  
...
### 4.2 已授权权限范围:[mingcute:key-2-line 20px/#40c057]:
...
- <strong>使用权限：</strong>  
允许将作品用于学习、欣赏、引用、复制、转载、非商业目的等个人用途。
...
*[适当模仿]: 模仿内容相似度不高于 40%，且不得直接或间接用于商业、盈利目的。