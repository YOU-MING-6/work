...
<template>
  <footer>
    <p style="color: var(--vp-c-text-2);">
      ...
      转载本站任何内容请遵守
      <VPLink class="footer-link" href="/notes/协议/转载.html">
        《转载文章内容协议》
      </VPLink>
    </p>
  </footer>
